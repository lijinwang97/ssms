...
SrsSTCoroutine::SrsSTCoroutine(std::string n, ISrsCoroutineHandler *h) {
    impl_ = new SrsFastCoroutine(n, h);
}

SrsSTCoroutine::SrsSTCoroutine(std::string n, ISrsCoroutineHandler *h, SrsContextId cid) {
...
SrsFastCoroutine::SrsFastCoroutine(std::string n, ISrsCoroutineHandler *h) {
...
SrsFastCoroutine::SrsFastCoroutine(std::string n, ISrsCoroutineHandler *h, SrsContextId cid) {
    name = n;
    handler = h;
    cid_ = cid;
    trd = NULL;
